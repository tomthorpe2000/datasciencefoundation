...
For my capstone project I am using the Forest Coverage dataset found at
...
The data was originally used by Jock Blackard of the US Forest Service for his Ph.D. thesis and other papers. Jock found that neural networks were able to predict forest coverage with 70% accuracy. This was a 12% improvement over the Discriminant Analysis methods currently in use which had an accuracy of 58%. 
...
* Climate Zone - 8 types, for example: montane, montane dry, sub apline, alpine, etc.  
...
In the current encoding a soil type represents one or more soil families. The new encoding would allow mutiple soil familes to be marked per row. Simlarly, there can be multiple rock densities in a soil type and multiple rock densities could be selected per row.
...
<<<<<<< HEAD
I will provide code for the various techniques used to predict the forest coverage and a discussion of the results in a paper and possible a lide deck.
=======
I will provide code for the various techniques used to predict the forest coverage and a discussion of the results in a paper and possible a lide deck.
>>>>>>> 748c98bf6746c325484535ab5a1fc5314e1ca3c5
