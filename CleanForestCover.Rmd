...
out1file="C:/Users/Tom/git/datasciencefoundation/ForestCoverage/forestcover_clean_full2.csv"
out2file="C:/Users/Tom/git/datasciencefoundation/ForestCoverage/forestcover_clean2.csv"
...
forestcover$ClimateName[forestcover$ClimateZone == 1] <- "Mont_LowDry"
forestcover$ClimateName[forestcover$ClimateZone == 2] <- "Montane_Low"
forestcover$ClimateName[forestcover$ClimateZone == 3] <- "Montane_Dry"
forestcover$ClimateName[forestcover$ClimateZone == 4] <- "Montane"
forestcover$ClimateName[forestcover$ClimateZone == 5] <- "Mon&Mon_Dry"
forestcover$ClimateName[forestcover$ClimateZone == 6] <- "Mon_SubAlp"
forestcover$ClimateName[forestcover$ClimateZone == 7] <- "SubAlpine"
forestcover$ClimateName[forestcover$ClimateZone == 8] <- "Alpine"  
